...
protected:
  ...
  node *insert_avl(node *p, Key k, node *merge_node, node **head_other,
...
BinaryTree<Key>::insert_to_tree(const value_type &value) {

  node *current = nullptr;
  this->head_element =
      insert_avl(this->head_element, value, nullptr, nullptr, &current);
